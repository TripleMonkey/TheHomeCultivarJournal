...
/*
 ViewModifier and extension to convert font with
 specific TextStyle to SF Rounded
 */
...
extension View {
    func sfRoundFont(for style: Font.TextStyle? = nil) -> some View {
        if style == nil {
